...
def crawl_restaurant_tripadvisor(nameCity, max_num_pages=100):
    ...
    for i in range(1,(max_num_pages+1)):
        ...
        if(driver.find_elements_by_xpath("/html/body/div[9]/div[8]/div")):
            question = driver.find_element_by_xpath("/html/body/div[9]/div[8]/div") 
            question.click()
...
def parse_restaurant_tripadvisor(strhtml,nameCity):
    ...
    for sec in soup.find_all(class_="shortSellDetails"):
        ...
        if(patro == None):
            ...
            # food category
            typefood = [secfood.get_text() for secfood in sec.find_all(class_="item cuisine")] # extraccion
